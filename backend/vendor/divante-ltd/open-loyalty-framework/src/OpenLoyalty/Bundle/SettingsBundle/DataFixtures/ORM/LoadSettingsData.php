...
class LoadSettingsData extends ContainerAwareFixture implements OrderedFixtureInterface
{
    ...
    public function load(ObjectManager $manager)
    {
        ...
        $currency = new StringSettingEntry('currency', 'IDR');
        $settings->addEntry($currency);

        $timezone = new StringSettingEntry('timezone', 'Asia/Jakarta');
        $settings->addEntry($timezone);

        $programName = new StringSettingEntry('programName', 'Yokke Loyalty');
